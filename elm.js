...
Elm.TicTacToe.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var getPositionFromSpace = function (space) {
      var _p0 = space;
      var position = _p0._0;
      return position;
   };
   var getScore = F3(function (depth,player,winState) {
      var _p1 = winState;
      if (_p1.ctor === "Win") {
            return _U.eq(_p1._0,player) ? 10 - depth : depth - 10;
         } else {
            return 0;
         }
   });
   var isSpaceOpen = function (space) {
      var _p2 = space;
      if (_p2.ctor === "_Tuple2" && _p2._1.ctor === "Open") {
            return true;
         } else {
            return false;
         }
   };
   var hasOpenSpaces = function (board) {
      return A2($List.any,isSpaceOpen,board);
   };
   var getPlayerFromSpace = function (space) {
      var _p3 = space;
      var square = _p3._1;
      var _p4 = square;
      if (_p4.ctor === "Taken") {
   ...
   var getNextPlayerFromBoard = F2(function (board,player) {
      var nextSpace = $List.head(board);
      var maybePlayer = A2($Maybe.andThen,
      nextSpace,
      getPlayerFromSpace);
      return A2($Maybe.andThen,
      maybePlayer,
      function (nextPlayer) {
         return _U.eq(nextPlayer,
         player) ? $Maybe.Just(player) : $Maybe.Nothing;
      });
   });
   var checkDiagonal = function (board) {
      return A2($Maybe.andThen,
      A2($Maybe.andThen,
      A2($Maybe.andThen,$List.head(board),getPlayerFromSpace),
      getNextPlayerFromBoard(A2($List.drop,4,board))),
      getNextPlayerFromBoard(A2($List.drop,8,board)));
   };
   var checkAntiDiagonal = function (board) {
      return A2($Maybe.andThen,
      A2($Maybe.andThen,
      A2($Maybe.andThen,
      $List.head(A2($List.drop,2,board)),
      getPlayerFromSpace),
      getNextPlayerFromBoard(A2($List.drop,4,board))),
      getNextPlayerFromBoard(A2($List.drop,6,board)));
   };
   var checkDiagonals = function (board) {
      return _U.list([checkDiagonal(board)
                     ,checkAntiDiagonal(board)]);
   };
   var checkColumn = F3(function (board,column,player) {
      var takenSpaces = A2($List.filter,
      function (s) {
         var _p5 = s;
         if (_p5.ctor === "_Tuple2" && _p5._0.ctor === "_Tuple2" && _p5._1.ctor === "Taken")
         {
               return _U.eq(column,_p5._0._1) && _U.eq(player,_p5._1._0);
            } else {
               return false;
            }
      },
      ...
      {
            return $Maybe.Just(player);
         } else {
            return $Maybe.Nothing;
         }
   });
   var checkRow = F3(function (board,row,player) {
      var takenSpaces = A2($List.filter,
      function (s) {
         var _p7 = s;
         if (_p7.ctor === "_Tuple2" && _p7._0.ctor === "_Tuple2" && _p7._1.ctor === "Taken")
         {
               return _U.eq(row,_p7._0._0) && _U.eq(player,_p7._1._0);
            } else {
               return false;
            }
      },
   ...
   var Draw = {ctor: "Draw"};
   var Win = function (a) {    return {ctor: "Win",_0: a};};
   var Playing = {ctor: "Playing"};
   var R = {ctor: "R"};
   var C = {ctor: "C"};
   var L = {ctor: "L"};
   var allColumns = _U.list([L,C,R]);
   var B = {ctor: "B"};
   var M = {ctor: "M"};
   var T = {ctor: "T"};
   var allRows = _U.list([T,M,B]);
   var Taken = function (a) {    return {ctor: "Taken",_0: a};};
   var play = F3(function (player,board,position) {
      return A2($List.map,
      function (_p9) {
         var _p10 = _p9;
         var _p11 = _p10._0;
         return _U.eq(position,_p11) ? {ctor: "_Tuple2"
                                       ,_0: _p11
                                       ,_1: Taken(player)} : {ctor: "_Tuple2",_0: _p11,_1: _p10._1};
      },
      board);
   });
   var Open = {ctor: "Open"};
   var openSpace = F2(function (row,column) {
      return {ctor: "_Tuple2"
             ,_0: {ctor: "_Tuple2",_0: row,_1: column}
             ,_1: Open};
   });
   var openBoard = A2($List.concatMap,
   function (r) {
      return A2($List.map,openSpace(r),allColumns);
   },
   allRows);
   var O = {ctor: "O"};
   var X = {ctor: "X"};
   ...
   var bothPlayers = _U.list([X,O]);
   var checkColumns = function (board) {
      return A2($List.concatMap,
      function (p) {
         return A2($List.map,
         function (r) {
            return A3(checkColumn,board,r,p);
         },
         allColumns);
      },
      bothPlayers);
   ...
   var checkWin = function (board) {
      var checks = A2($Basics._op["++"],
      checkRows(board),
      A2($Basics._op["++"],
      checkColumns(board),
      checkDiagonals(board)));
      var maybePlayer = $List.head(A2($List.filterMap,
      $Basics.identity,
      checks));
      var _p13 = maybePlayer;
      if (_p13.ctor === "Just") {
            return Win(_p13._0);
         } else {
            return hasOpenSpaces(board) ? Playing : Draw;
         }
   };
   var minimax = F4(function (depth,
   originalPlayer,
   currentPlayer,
   board) {
      var initialWinState = checkWin(board);
      var availableSpaces = A2($List.filter,isSpaceOpen,board);
      var _p14 = {ctor: "_Tuple2"
                 ,_0: $List.length(availableSpaces)
                 ,_1: initialWinState};
      _v10_3: do {
         _v10_0: do {
            if (_p14.ctor === "_Tuple2") {
                  switch (_p14._1.ctor)
                  {case "Win": if (_p14._0 === 9) {
                             break _v10_0;
                          } else {
                             return {ctor: "_Tuple2"
                                    ,_0: A3(getScore,depth,originalPlayer,initialWinState)
                                    ,_1: $Maybe.Nothing};
                          }
                     case "Draw": if (_p14._0 === 9) {
                             break _v10_0;
                          } else {
                             return {ctor: "_Tuple2",_0: 0,_1: $Maybe.Nothing};
                          }
                     default: if (_p14._0 === 9) {
                             break _v10_0;
                          } else {
                             break _v10_3;
                          }}
         ...
         return {ctor: "_Tuple2"
                ,_0: 10
                ,_1: $Maybe.Just({ctor: "_Tuple2",_0: B,_1: R})};
      } while (false);
      var availablePositions = A2($List.map,
      getPositionFromSpace,
      availableSpaces);
      var scoresAndMoves = A2($List.map,
      function (position) {
         var newBoard = A3(play,currentPlayer,board,position);
         var winState = checkWin(newBoard);
         var _p15 = winState;
         if (_p15.ctor === "Playing") {
               ...
               return {ctor: "_Tuple2"
                      ,_0: A3(getScore,depth,originalPlayer,winState)
                      ,_1: $Maybe.Just(position)};
            }
      },
      availablePositions);
      return _U.eq(originalPlayer,
      currentPlayer) ? A2($Maybe.withDefault,
      {ctor: "_Tuple2",_0: 0,_1: $Maybe.Nothing},
      A2($List$Extra.minimumBy,
      $Basics.fst,
      scoresAndMoves)) : A2($Maybe.withDefault,
      {ctor: "_Tuple2",_0: 0,_1: $Maybe.Nothing},
      A2($List$Extra.maximumBy,$Basics.fst,scoresAndMoves));
   });
   return _elm.TicTacToe.values = {_op: _op
                                  ...
                                  ,checkRows: checkRows
                                  ,getPlayerFromSpace: getPlayerFromSpace
                                  ,getNextPlayerFromBoard: getNextPlayerFromBoard
                                  ,checkDiagonal: checkDiagonal
                                  ,checkAntiDiagonal: checkAntiDiagonal
                                  ,checkDiagonals: checkDiagonals
                                  ,isSpaceOpen: isSpaceOpen
                                  ,hasOpenSpaces: hasOpenSpaces
                                  ,checkWin: checkWin
                                  ,openSpace: openSpace
                                  ,openBoard: openBoard
                                  ,getScore: getScore
                                  ,getPositionFromSpace: getPositionFromSpace
                                  ,minimax: minimax};
};
Elm.App = Elm.App || {};
Elm.App.make = function (_elm) {
   ...
   var _op = {};
   var containerStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                        ,_0: "display"
                                                        ,_1: "flex"}
                                                       ,{ctor: "_Tuple2",_0: "justify-content",_1: "center"}]));
   var viewBoardStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                        ,_0: "display"
                                                        ,_1: "flex"}
                                                       ,{ctor: "_Tuple2",_0: "flex-direction",_1: "column"}
                                                       ,{ctor: "_Tuple2",_0: "width",_1: "500px"}
                                                       ,{ctor: "_Tuple2",_0: "height",_1: "500px"}]));
   var viewSpaceRowStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                           ,_0: "flex"
                                                           ,_1: "1"}
                                                          ,{ctor: "_Tuple2",_0: "display",_1: "flex"}]));
   var viewPlayer = function (player) {
      return _U.eq(player,$TicTacToe.X) ? A2($Html.i,
      _U.list([$Html$Attributes.$class("fa fa-times fa-5x")]),
      _U.list([])) : A2($Html.i,
      _U.list([$Html$Attributes.$class("fa fa-circle-o fa-5x")]),
      _U.list([]));
   };
   var borderColor = "#000000";
   var topBorder = {ctor: "_Tuple2"
                   ,_0: "border-top"
                   ,_1: A2($Basics._op["++"],"2px solid ",borderColor)};
   var leftBorder = {ctor: "_Tuple2"
                    ,_0: "border-left"
                    ,_1: A2($Basics._op["++"],"2px solid ",borderColor)};
   var rightBorder = {ctor: "_Tuple2"
                     ,_0: "border-right"
                     ,_1: A2($Basics._op["++"],"2px solid ",borderColor)};
   var bottomBorder = {ctor: "_Tuple2"
                      ,_0: "border-bottom"
                      ,_1: A2($Basics._op["++"],"2px solid ",borderColor)};
   var getBorders = function (position) {
      var _p0 = position;
      switch (_p0._0.ctor)
      {case "T": switch (_p0._1.ctor)
           {case "L": return _U.list([bottomBorder,rightBorder]);
              case "C": return _U.list([leftBorder,rightBorder,bottomBorder]);
              default: return _U.list([leftBorder,bottomBorder]);}
         case "M": switch (_p0._1.ctor)
           {case "L": return _U.list([bottomBorder,rightBorder,topBorder]);
              case "C": return _U.list([leftBorder
                                       ,rightBorder
                                       ,topBorder
                                       ,bottomBorder]);
              default: return _U.list([leftBorder,topBorder,bottomBorder]);}
         default: switch (_p0._1.ctor)
           {case "L": return _U.list([topBorder,rightBorder]);
              case "C": return _U.list([leftBorder,rightBorder,topBorder]);
              default: return _U.list([topBorder,leftBorder]);}}
   };
   var viewSpaceStyle = function (position) {
      return $Html$Attributes.style(A2($Basics._op["++"],
      _U.list([{ctor: "_Tuple2",_0: "flex",_1: "1"}
              ,{ctor: "_Tuple2",_0: "display",_1: "flex"}
              ,{ctor: "_Tuple2",_0: "justify-content",_1: "center"}
   ...
   var update = F2(function (action,model) {
      var _p1 = action;
      if (_p1.ctor === "Play") {
            var player = $TicTacToe.opponent(model.lastPlayer);
            var newBoard = A3($TicTacToe.play,player,model.board,_p1._0);
            return _U.update(model,{board: newBoard,lastPlayer: player});
         } else {
            return model;
         }
   });
   var init = {board: $TicTacToe.openBoard
              ,lastPlayer: $TicTacToe.O};
   var NoOp = {ctor: "NoOp"};
   var Play = function (a) {    return {ctor: "Play",_0: a};};
   var viewSpace = F2(function (address,space) {
      var _p2 = space;
      if (_p2._1.ctor === "Open") {
            var _p3 = _p2._0;
            return A2($Html.div,
            _U.list([viewSpaceStyle(_p3)
                    ,A2($Html$Events.onClick,address,Play(_p3))]),
            _U.list([]));
         } else {
            return A2($Html.div,
            _U.list([viewSpaceStyle(_p2._0)]),
            _U.list([viewPlayer(_p2._1._0)]));
         }
   });
   var viewSpaceRow = F2(function (address,spaces) {
      return A2($Html.div,
      _U.list([viewSpaceRowStyle]),
      A2($List.map,viewSpace(address),spaces));
   });
   var partitionGrid = F2(function (address,spaces) {
      var _p4 = spaces;
      if (_p4.ctor === "[]") {
            return _U.list([$Html.text("")]);
         } else {
            return A2($Basics._op["++"],
            _U.list([A2(viewSpaceRow,address,A2($List.take,3,spaces))]),
            A2(partitionGrid,address,A2($List.drop,3,spaces)));
         }
   });
   var viewBoard = F2(function (address,board) {
      return A2($Html.div,
      _U.list([viewBoardStyle]),
      A2(partitionGrid,address,board));
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([containerStyle]),
      _U.list([A2(viewBoard,address,model.board)
              ,$Html.text($Basics.toString(A4($TicTacToe.minimax,
              0,
              $TicTacToe.opponent(model.lastPlayer),
              $TicTacToe.opponent(model.lastPlayer),
              model.board)))]));
   });
   var Model = F2(function (a,b) {
      return {board: a,lastPlayer: b};
   });
   return _elm.App.values = {_op: _op
                            ...
                            ,viewSpaceStyle: viewSpaceStyle
                            ,viewPlayer: viewPlayer
                            ,viewSpace: viewSpace
                            ,viewSpaceRowStyle: viewSpaceRowStyle
                            ,viewSpaceRow: viewSpaceRow
                            ,partitionGrid: partitionGrid
                            ,viewBoardStyle: viewBoardStyle
                            ,viewBoard: viewBoard
...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var main = $StartApp$Simple.start({model: $App.init
                                     ,update: $App.update
                                     ,view: $App.view});
